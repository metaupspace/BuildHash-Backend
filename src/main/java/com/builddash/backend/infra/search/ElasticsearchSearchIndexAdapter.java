...
public class ElasticsearchSearchIndexAdapter implements SearchIndex {
    ...
    private static final Logger log = LoggerFactory.getLogger(ElasticsearchSearchIndexAdapter.class);
    private static final String PRODUCTS_ALIAS = "products";
    private static final int VERSION_CONFLICT_STATUS = 409;

    private final ElasticsearchClient client;

    public ElasticsearchSearchIndexAdapter(ElasticsearchClient client) {
        this.client = client;
    }
